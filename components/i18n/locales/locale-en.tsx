...
export class LocaleEn implements Translations {
  ...
  profileDescription =
    'A passionate, self-driven and creative fullstack developer with experience building applications across diverse technologies—since the age of 13, and continually evolving.';
