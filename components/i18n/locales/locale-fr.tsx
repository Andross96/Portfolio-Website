...
export class LocaleFr implements Translations {
  ...
  profileDescription =
    "Développeur fullstack passionné, autonome et créatif, avec de l'expérience dans la création d'applications sur des technologies variées — depuis l’âge de 13 ans, et en constante évolution.";
